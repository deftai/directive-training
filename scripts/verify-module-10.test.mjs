...
test("verifier rejects a stale or ranged learner baseline", () => {
  const root = changedCopy("curriculum/modules/10-implementation-golden-path.md", (body) => body.replace(
    ...
    "| Directive baseline | fixture-local `@deftai/directive@0.119.5–0.114.0`, engine `@deftai/directive-core@0.119.5`; see the [source baseline](../../references/SOURCE-BASELINE.md) |",
  ));
