...
for (const [label, path, mutate, pattern] of [
  ...
  [
    "a Module 6 solution Artifact path that disagrees with Lab 7",
    solution6,
    (body) => splice(body, "2026-01-15-your-proposed-scope.xbrief.json", "2026-01-15-northstar-delayed-route-preview.xbrief.json"),
    /must use 2026-01-15-your-proposed-scope/,
  ],
  [
