...
| Collapse state | The live authoring CLI, package pin, tracked generation, generated `AGENTS.md` guidance and provenance, xBRIEF pin, fixtures, and current learner surfaces all target 0.119.5. `deft agents:refresh --check` confirms the regenerated managed body is current against the 0.119.5 deposit. Historical 0.112.0 evidence remains labeled in `SOURCE-NOTES.md` and delivery records. |
