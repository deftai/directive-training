...
| Collapse state | The live authoring CLI, package pin, tracked generation, managed guidance, xBRIEF pin, fixtures, and current learner surfaces all target 0.119.5. Historical 0.112.0 evidence remains labeled in `SOURCE-NOTES.md` and delivery records. |
